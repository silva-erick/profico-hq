...
*/
	SELECT	campanha_origem
			, campanha_modalidade
			, COUNT(1) qtd
			, AVG(geral_posts) filter( campanha_status != 'Falha' ) avg_posts
			, AVG(geral_posts) filter( campanha_status == 'Falha' ) avg_posts_falha
			, AVG(geral_total_contribuicoes) filter( campanha_status != 'Falha' ) avg_contribuicoes
			, AVG(geral_total_contribuicoes) filter( campanha_status == 'Falha' ) avg_contribuicoes_falha
