...
async def raspar_catarse(args):
    ...
    res = finished.execute(args.verbose, log_level)
    if args.verbose:
        print(f"Data fetched", flush=True)
...
async def raspar_catarse_categories(args):
    ...
    if args.verbose:
        print('Catarse - Categories - Done', flush=True)
...
async def raspar_catarse_cities(args):
    ...
    if args.verbose:
        print('Catarse - Cities - Done', flush=True)
