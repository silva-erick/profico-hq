...
class CoordenadorAnaliseDescritiva(analisebase.AnaliseInterface):
    ...
    def _gerar_md_recorte(self, mod, pasta_md, pasta_img, df_recorte, mapa_agrupamento):
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Taxa de Sucesso das Modalidades',
            'Modalidade',
            'Taxa de Sucesso',
            'Taxa de Sucesso',
            analisebase.numero_percent1_f
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Total Arrecadado por Modalidades',
            'Modalidade',
            'Total Arrecadado (R$)',
            'Total Arrecadado (R$)',
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Média Arrecadada por Campanha por Modalidades',
            'Modalidade',
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Apoio Médio por Campanha por Modalidades',
            'Modalidade',
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Total de Contribuições por Modalidades',
            'Modalidade',
        ...
        analisebase._gerar_grafico_barras_horizontais(
            ...
            'Média de Contribuições por Campanha por Modalidades',
            'Modalidade',
