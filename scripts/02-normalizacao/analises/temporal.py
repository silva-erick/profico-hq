...
def _gerar_serie_por_modalidade(df, ano, modalidade, nome_modalidade, pasta_md, pasta_dados, arquivo, titulo,  template, analise_md):
    ...
    with open(f'{pasta_md}/{arquivo}.md', 'w', encoding='utf8') as md_descritivo:
        ...
        md_descritivo.write('\n')
        md_descritivo.write('\n')
        md_descritivo.write(f'Modalidade {nome_modalidade}: Total de Campanhas')
        md_descritivo.write('\n')
        md_descritivo.write('\n')
        ...
        md_descritivo.write('\n')
        md_descritivo.write('\n')
        md_descritivo.write(f'Modalidade {nome_modalidade}: Total de Campanhas bem Sucedidas')
        md_descritivo.write('\n')
        md_descritivo.write('\n')
        ...
        md_descritivo.write('\n')
        md_descritivo.write('\n')
        md_descritivo.write(f'Modalidade {nome_modalidade}: Taxa de Sucesso')
        md_descritivo.write('\n')
        md_descritivo.write('\n')
