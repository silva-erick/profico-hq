...
def _gerar_mermaid(df, df_resumo, origens):
    ...
    mermaid = mermaid + f'em {total_campanhas_aon} tudo ou nada e {total_campanhas_flex} flex. As campanhas recorrentes estão em {total_campanhas_sub}.\n'
    ...
    mermaid = mermaid + f'      camp_pontual_flex("{total_campanhas_flex} flex")\n'
